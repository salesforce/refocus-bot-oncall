...
module.exports = {
  ...
  dev: {
    ...
    redisCacheUrl: process.env.REDIS_CACHE_URL_DEV || 'redis://127.0.0.1:6379',
  ...
  sandbox: {
    ...
    redisCacheUrl: process.env.REDIS_CACHE_URL_SANDBOX,
  ...
  production: {
    ...
    redisCacheUrl: process.env.REDIS_CACHE_URL_PROD,
